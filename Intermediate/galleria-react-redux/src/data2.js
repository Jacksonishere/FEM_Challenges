export const GalleryData = [
	...
	},
	{
		...
		artist: {
			image: require("./assets/the-storm-on-the-sea-of-galilee/artist.jpg").default,
			name: "Rembrandt",
		},
		images: {
			thumbnail: require("./assets/the-storm-on-the-sea-of-galilee/thumbnail.jpg").default,
			hero: {
				small: require("./assets/the-storm-on-the-sea-of-galilee/hero-small.jpg").default,
				large: require("./assets/the-storm-on-the-sea-of-galilee/hero-large.jpg").default,
			},
	...
	},
	{
		...
		images: {
			thumbnail: require("./assets/the-boy-in-the-red-vest/thumbnail.jpg").default,
			hero: {
				small: require("./assets/the-boy-in-the-red-vest/hero-small.jpg").default,
				large: require("./assets/the-boy-in-the-red-vest/hero-large.jpg").default,
			},
	...
	},
	{
		...
		images: {
			thumbnail: require("./assets/girl-with-pearl-earring/thumbnail.jpg").default,
			hero: {
				small: require("./assets/girl-with-pearl-earring/hero-small.jpg").default,
				large: require("./assets/girl-with-pearl-earring/hero-large.jpg").default,
			},
	...
	},
	{
		...
		images: {
			thumbnail: require("./assets/the-great-wave-off-kanagawa/thumbnail.jpg").default,
			hero: {
				small: require("./assets/the-great-wave-off-kanagawa/hero-small.jpg").default,
				large: require("./assets/the-great-wave-off-kanagawa/hero-large.jpg").default,
			},
	...
	},
	{
		...
		images: {
			thumbnail: require("./assets/van-gogh-self-portrait/thumbnail.jpg").default,
			hero: {
				small: require("./assets/van-gogh-self-portrait/hero-small.jpg").default,
				large: require("./assets/van-gogh-self-portrait/hero-large.jpg").default,
			},
